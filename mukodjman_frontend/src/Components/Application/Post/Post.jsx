...
//     let [tempLikes, setTempLikes] = useState(0)
...
//                                     <FavoriteBorderIcon />
//                                 )}
//                                 {Number(props.reactions.length) + localLike}
//                             </div>
//                                 </>
//                         </div>
//                     </div>
...
//                         <img 
//                             src={`http://192.168.1.133:4400/uploads/${pictureToDisplay}`}
//                             alt="Post"
//                             style={{
//                                 maxWidth: '90vw',
//                                 maxHeight: '90vh',
                        ...
                        <div className={style.images} style={{ display: props.images && props.images.length === 0 ? "none" : "flex" }}>
                            {props.images && props.images.map((image) => {
                                return <div onClick={(e) => {
                                    ...
                                    backgroundImage: `url(${`http://192.168.1.133:4400/uploads/${image.imageUrl}`})`,
                                    backgroundSize: 'cover',
                                    backgroundPosition: 'center',
                                    width: '200px',
                                    height: '200px',
